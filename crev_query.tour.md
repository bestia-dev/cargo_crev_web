...
##### step 1 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/main.rs#L266)
```rust
    clippy::nursery,
    clippy::cargo,
...
##### step 2 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/crev_query_mod.rs#L32)
## template on disk  
Read the template from the disk and start the rendering.

##### step 3 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/crev_query_mod.rs#L37)
...
##### step 4 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L77)
## must implement methods
In the same trait we have specific functions that must be implemented for every data model separately.

##### step 5 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L66)
...
##### step 6 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L81)
...
##### step 7 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L153)
## new node
A new html node/element/tag. We create a new Node with only the basic data.

##### step 8 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L160)
## Svg namespace
Svg inside Html must be specially adorned with a namespace. Very annoying.

##### step 9 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L169)
## fill node recursively
The new node we created will be filled in this method. This goes recursive.

##### step 10 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L181)
## fill_element_node()  
...
##### step 11 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L141)
...
##### step 12 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/web_server_folder/templates/query/crev_query_template.html#L28)
## dynamic content
...
##### step 13 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/web_server_folder/templates/query/crev_query_template.html#L42)
## replace text  
...
##### step 14 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/web_server_folder/templates/query/crev_query_template.html#L48)
## text placeholder
...
##### step 15 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L246)
## dynamic data
...
##### step 16 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/all_summary_mod.rs#L146)
## next TextNode
...
##### step 17 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L229)
## push to parent node
Then this dynamic TextNode is pushed to the parent node.

##### step 18 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L237)
## boolean placeholder
The special comment \<!--b_...--\> can result in true or false. 
It leaves or removes the next node completely.

##### step 19 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/web_server_folder/templates/query/crev_query_template.html#L105)
## boolean
The rendering finds the placeholder and calls the implementation method.
It saves temporarily the result.

##### step 20 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L249)
## next node
...
##### step 21 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/html_template_mod.rs#L183)
## boolean method
The implemented method returns true or false for the placeholder according to the data.

##### step 22 of 22 [View code in GitHub](https://github.com/bestia-dev/cargo_crev_web/blob/master/src/proof_mod.rs#L125)
